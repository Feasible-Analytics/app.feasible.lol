...
/** barWidth is how wide one bar is drawn, given the plot it has to share and
 ...
 *  it starts and how wide it is. The height is the caller's, because only it
 *  knows the y scale. */
export interface BarRect {
	series: "current" | "earlier";
	value: number;
	x: number;
	width: number;
}
