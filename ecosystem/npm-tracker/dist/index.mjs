//
// index.mjs
// The ESM build of the loader. Hand-written and committed: there is no bundler and no build step.
//
// Created: 2026-08-30
...
export default { init, track, pageview, enable, disable, isEnabled };
