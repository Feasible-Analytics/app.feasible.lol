...
// TestSumIsScaledBySamplingAndTheOthersAreNot checks the one property of these
// metrics that sampling changes. A total read from a tenth of the visitors is a
// tenth of the total; an average, a minimum and a percentile are statements
// about the values and are the same whichever visitors were read.
func TestSumIsScaledBySamplingAndTheOthersAreNot(t *testing.T) {
